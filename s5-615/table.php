  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="white-space: nowrap">
        <form method="post" action="http://localhost/pwa/615/delete.php" style="display: inline-block">        
          <input type="hidden" name="id" value="<?=$todo['id']?>">
          <button class="btn red">Delete</button>
        </form>
        <form method="get" action="http://localhost/pwa/615/editForm.php" style="display: inline-block">        
          <input type="hidden" name="id" value="<?=$todo['id']?>">
